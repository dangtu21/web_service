										...
										<form class="row g-3" action="{{route('LogIn')}}" method="post">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="inputChoosePassword" value="12345678" placeholder="Enter Password" name="password" required> <a href="javascript:;" class="input-group-text bg-transparent" name="password"><i class="bx bx-hide"></i></a>
												</div>
											</div>
											<div class="col-md-6">
