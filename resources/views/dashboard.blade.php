                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="row py-3 contacts w-100 mx-auto"
                                        ...
                                        <div class="col invoice-to text-left">
                                            ...
                                            <div class="ip" id="ip">IP đang truy cập:
                                                2405:4802:8030:9e00:c0d3:cf37:74c8:5576</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-0">
                                    ...
                                    <li class="list-group-item bg-transparent">
                                        <div class="container"
                                            ...
                                            <div class="container text-center" style=" color: #fff;">
                                                <span style="color: #fff;font-size: 20px;font-weight: 500;">Thống
                                                    kê sử dụng </span>
                                            ...
                                            <div class="progress mb-1"
                                                ...
                                                <div class="progress-bar progress-bar-striped progress-bar-animated"
                                                    role="progressbar" style="width: 20%; background-color: #fff;">
                                ...
                                <div class="d-grid text-center">
                                    <div class="d-flex flex-wrap justify-content-center">
                                        ...
                                        <div class="p-2">
                                            <a class="btn btn-light w-100 radius-30" style="font-size: 12PX;"
                                                href="{{route('document')}}">
                                        ...
                                        <div class="p-2">
                                            <a class="btn btn-light w-100 radius-30" style="font-size: 12PX;"
                                                href="https://mangvip.com/idapple/">
                                ...
                                <div class="row justify-content-center"
                                    ...
                                    <button class="btn btn-light my-3 radius-30 mx-auto" id="synchronize" style="font-size: small;"
                        ...
                        <table class="table " style="font-size: 1rem ; border-radius:20px; overflow: hidden;"">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><svg xmlns="http://www.w3.org/2000/svg" style="font-size:28px"
                    ...
                    <div class="menu2111" id="menu2111" style="padding-bottom: 15px">
                        ...
                        <ul class="list-unstyled" style="padding-left: 0;">
                            <li style="border-bottom: 1px solid #757070; padding: 10px 0;cursor:pointer"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="text-center" style="width: 30%;">
                                        <img class="mr-2" src="{{ asset('assets/images/app/copy.png') }}" alt="V2RayNG"
                            ...
                            <li style="border-bottom: 1px solid #757070; padding: 10px 0; cursor: pointer;"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="text-center" style="width: 30%;">
                                        <img class="mr-2" src="{{ asset('assets/images/app/qr.png') }}" alt="V2RayNG"
                                            style="width: 50px; margin: 0 1rem;">
                                    </div>
                            ...
                            <li style="border-bottom: 1px solid #757070; padding: 10px 0;">
                                <div class="d-flex align-items-center">
                                    <div class="text-center" style="width: 30%;">
                                        <img class="mr-2" src="{{ asset('assets/images/app/clashforandroi.png') }}"
                                            alt="V2RayNG" style="width: 50px; margin: 0 1rem;">
                                    </div>
