                ...
                <div class="modal-body" id="modal-body">
                    <div class="custom-html-style">
                        <p><strong>CÁCH SỬ DỤNG ĐƠN GIẢN THÔI NHÉ CÁC BẠN.</strong><br>
                            🔴 <strong>Đầu tiên các bạn xem video hướng dẫn chi tiết trên kênh Youtube
                                4GFUTURE:</strong> 👉<a href="https://youtu.be/MRB4sonhkoc"><strong>TẠI ĐÂY</strong></a>
                            👈<br>
                            <strong>-&gt;&gt;sau khi xem video xong, các bạn làm theo video cùng với 4 bước bên dưới là
                        ...
                        <p>----- <strong>Bước 2: Tải app Nekobox để chạy 4G FUTURE</strong><br>
                            ...
                            lưu ý: hiện tại nhà phát triển đã đổi tên app Nekobox thành MIproxy, nên khi các bạn tải về
                            thấy tên là MIproxy thì không vấn đề gì nhé</p>
                        <p>-----<strong>Bước 3: Đồng bộ máy chủ của gói data 4GFUTURE mà các bạn đã mua vào app
                                Nekobox</strong></p>
                        <ul>
                            <li>thao tác như ảnh bên dưới để đồng bộ máy chủ của gói data 4GFUTURE mà các bạn đã mua vào
                                app Nekobox (các bạn có thể nhấn giữ vào ảnh để tải ảnh hướng dẫn xuống nếu không phóng
                                to ảnh trên điện thoại lên được)<br>
                                <img src="https://s3.ap-northeast-1.amazonaws.com/h.files/images/1718132471497_XgJPV88oNY.jpg"
                                    alt="" style="width:80%">
                            </li>
                        </ul>
                        <p>----- <strong>Bước 4 : Đăng ký nền Viettel</strong><br>
                            👉 <strong>Tùy theo nhu cầu sử dụng của các bạn thì các bạn đăng ký gói nền cho phù hợp dưới
                                đây nhé:</strong></p>
                        <ul>
                            <li><strong>T50K:</strong> cú pháp đăng ký ‘‘<strong>T50K gửi 191</strong>’’, 50k/tháng,
                                50GB/tháng</li>
                            <li><strong>T15KN:</strong> cú pháp đăng ký ‘‘<strong>T15KN gửi 191</strong>’’, 15k/7 ngày,
                                25GB/7 ngày, 100GB/tháng</li>
                            <li><strong>T5K:</strong> cú pháp đăng ký ‘‘<strong>T5K gửi 191</strong>’’, 5k/ngày,
                                15GB/ngày, 450GB/tháng</li>
                            <li><strong>MXH100:</strong> cú pháp đăng ký ‘‘<strong>MXH100 gửi 191</strong>’’,
                                100k/tháng, không giới hạn dung lượng sử dụng</li>
                        </ul>
                        <p>⚠ <strong>Một số lưu ý của bước đăng ký nền</strong><br>
                            • trong video hướng dẫn đăng ký gói nền T30 nhưng hiện tại gói nền T30 của viettel đã ngừng
                            đăng ký mới, nên các bạn đăng ký các nền bên trên<br>
                            • gói nền T5K,T15KN,T50K của Viettel chỉ dùng để xem Tiktok nhưng kết hợp với gói DATA
                            4GFUTURE sẽ dùng được hết các ứng dụng khác như : facebook , youtube,tiktok,zalo, instagram,
                            truy cập web,chơi game,…<br>
                            • gói nền MXH100 của Viettel chỉ dùng để xem tiktok,youtube,facebook nhưng kết hợp với gói
                            DATA 4GFUTURE sẽ dùng được hết các ứng dụng khác như : zalo, instagram, truy cập web,xem
                            phim,chơi game,…mà không giới hạn dung lượng<br>
                        ...
                        <p><strong>VẬY LÀ XONG RỒI NHÉ . BÂY GIỜ CÁC BẠN CHỌN SERVER TRONG NEKOBOX VÀ DÙNG MẠNG
                                THÔI</strong></p>
                        <hr><br>
                    </div>
                </div>
