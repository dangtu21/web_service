const contentMap = {
    ...
    'content4': `<div class="custom-html-style"><p><strong>CÁCH SỬ DỤNG ĐƠN GIẢN THÔI NHÉ CÁC BẠN.</strong> <br>
                ...
                • gói nền T5K,T15KN,T50K của Viettel chỉ dùng để xem Tiktok nhưng kết hợp với gói DATA MANGVIP sẽ dùng được hết các ứng dụng khác như : facebook , youtube,tiktok,zalo, instagram, truy cập web,chơi game,…<br>
                • gói nền MXH100 của Viettel chỉ dùng để xem tiktok,youtube,facebook nhưng kết hợp với gói DATA MANGVIP sẽ dùng được hết các ứng dụng khác như : zalo, instagram, truy cập web,xem phim,chơi game,…mà không giới hạn dung lượng<br>
                • đăng ký nền xong mà hủy gói nền là sẽ không có mạng<br>
                • gói nền T5K,T15KN,T50K,MXH100 là của Viettel không phải của MANGVIP</p>
...
const contentArray = [{
        ...
        content: `<div class="custom-html-style">
                    ...
                    <ul>
                        <li>thao tác như ảnh bên dưới để đồng bộ máy chủ của gói data mangvip mà các bạn đã mua vào app Nekobox (các bạn có thể nhấn giữ vào ảnh để tải ảnh hướng dẫn xuống nếu không phóng to ảnh trên điện thoại lên được)<br>
